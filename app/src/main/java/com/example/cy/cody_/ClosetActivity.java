...
public class ClosetActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ArrayList에 값 추가하기
        itemArrayList.add(new item("상의 - Long",  R.drawable.top));
        itemArrayList.add(new item("상의 - Short",  R.drawable.top_s));
        itemArrayList.add(new item("하의 - Long",  R.drawable.bottom));
        itemArrayList.add(new item("하의 - Short",  R.drawable.bottom_s));
