...
//        }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                Toast.makeText(Bottom_longActivity.this, ""+position,Toast.LENGTH_SHORT).show();
            }
        });
        ...
        new AsyncTask<String, String, String>() {
            ...
            protected String doInBackground(String... strings) {
                ...
                try{
                    ...
                    URL url = new URL("http://113.198.229.173/Bottom.php");
                    ...
                    for(int i=0; i < jsonArray.length(); i++){
                        ...
                        Bottom_list.add( DataJsonObject.getString("Bottom_file") );

                    }

                    Log.v("JIN_TOP", Bottom_list.toString());
            ...
            protected void onPostExecute(String s) {
                ...
                gridView.setAdapter( new ImageAdapter(Bottom_longActivity.this, Bottom_list, "Bottom") );
